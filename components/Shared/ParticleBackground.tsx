...
export default function ParticleBackground() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      // Use light theme background color with transparency
      const bgRgb = { r: 248, g: 249, b: 251 }; // #F8F9FB
      ctx.fillStyle = `rgba(${bgRgb.r}, ${bgRgb.g}, ${bgRgb.b}, 0.1)`;
      ctx.fillRect(0, 0, canvas.width, canvas.height);

      // Use indigo primary color for particles
      const primaryRgb = { r: 79, g: 70, b: 229 }; // #4F46E5
