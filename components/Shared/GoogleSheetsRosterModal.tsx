...
export default function GoogleSheetsRosterModal({ open, onClose, headers, teams, shiftDefinitions }: Props) {
  const [selectedTeams, setSelectedTeams] = useState<string[]>([]);
  const [monthOffset, setMonthOffset] = useState(0);
  
  // Use tenant-specific shift definitions or empty (since this is Google data, descriptions aren't shown)
