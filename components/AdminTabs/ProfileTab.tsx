      ...
      <div className="section-card">
        ...
        <div className="actions-row">
          <button className="btn primary" onClick={updateProfile} disabled={loading}>
            {loading ? 'Updating...' : <><Save size={16} style={{display:'inline', marginRight:'6px'}} /> Update Profile</>}
          </button>
        </div>
      </div>
      ...
      <div className="section-card">
        ...
        <div className="actions-row">
          <button className="btn primary" onClick={changePassword} disabled={loading}>
            {loading ? 'Changing...' : <><Lock size={16} style={{display:'inline', marginRight:6}} />Change Password</>}
          </button>
        </div>
      </div>
    </div>
