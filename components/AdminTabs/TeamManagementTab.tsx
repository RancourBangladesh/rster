...
import { Edit, Save, Plus, Mail } from 'lucide-react';
    ...
    <div className="modal-overlay" onClick={onCancel}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-footer">
          <button className="btn primary" onClick={() => onSave(empName, empId)}><Save size={16} style={{display:'inline', marginRight:'6px'}} /> Save</button>
      ...
      <div key={e.id} className="tm-employee-card">
        <div className="row1">
          ...
          <div className="emp-actions">
            <button 
              className="icon-btn tiny" 
              onClick={() => setSendingPasswordTo({ id: e.id, name: e.name })}
              title="Send password setup link"
              style={{ color: 'var(--primary)' }}
            >
              <Mail size={14} />
            </button>
            <button className="icon-btn tiny" onClick={() => startEmpEdit(e, selectedTeam)}>< Edit size={14} /></button>
          ...
          <div className="teams-panel">
              ...
              {teamKeys.map(t => (
                <li key={t} className={t === selectedTeam ? 'active' : ''}>
                  ...
                  <div className="row-actions">
                    <button className="icon-btn" title="Edit" onClick={() => startTeamEdit(t)}>< Edit size={14} /></button>
            ...
            <div className="team-form">
              ...
              <div className="actions-row">
                {!editingTeam && <button className="btn primary small" onClick={addTeam}><Plus size={16} style={{display:'inline', marginRight:'6px'}} /> Add</button>}
                {editingTeam && <>
                  <button className="btn primary small" onClick={editTeam}><Save size={16} style={{display:'inline', marginRight:'6px'}} /> Save</button>
            ...
            {selectedTeam && (
              <>
                    ...
                    <tbody>
                      ...
                      {data.teams[selectedTeam]?.map(e => (
                        <tr key={e.id}>
                          ...
                          <td>{e.id}</td>
                          <td>
                            <button className="icon-btn" onClick={() => startEmpEdit(e, selectedTeam)}>< Edit size={14} /></button>
                ...
                <div className="employee-form">
                  ...
                  <div className="actions-row">
                    <button className="btn primary small" onClick={addEmployee}><Plus size={16} style={{display:'inline', marginRight:'6px'}} /> Add Employee</button>
                  </div>
                </div>
              </>
            )}
