    ...
    <div id={id} className="adm-dark-root">
      ...
      <div className="adm-bar">
        ...
        <div className="adm-bar-actions">
          ...
          <button className="adm-btn refresh" onClick={load} disabled={loading || saving} style={{display:'flex', alignItems:'center', gap:6, justifyContent:'center'}}>
            <RefreshCw size={16} />
            {loading ? 'Loading…' : saving ? 'Saving…' : 'Refresh'}
          </button>
          <button className="adm-btn view" onClick={()=>setShowShiftView(true)} disabled={loading || !adminData} style={{display:'flex', alignItems:'center', gap:6, justifyContent:'center'}}>
            <Eye size={16} />
            Shift View
          </button>
          <button className="adm-btn reset" onClick={resetToGoogle} disabled={loading || saving || resetting || !googleData} style={{display:'flex', alignItems:'center', gap:6, justifyContent:'center'}}>
            <RotateCcw size={16} />
