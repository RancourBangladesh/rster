    ...
    return (
      <tr key={u.username}>
        ...
        <td style={{ whiteSpace: 'nowrap' }}>
          <button className="icon-btn tiny" onClick={() => startEdit(u)}><Edit size={14} /></button>
      ...
      <div className="section-card um-form-card">
        ...
        <div className="actions-row">
          <button className="btn primary small" onClick={saveUser}>
            {editing ? <><Save size={16} style={{display:'inline', marginRight:'6px'}} /> Save</> : <><Plus size={16} style={{display:'inline', marginRight:'6px'}} /> Add User</>}
          </button>
          {editing && (
