...
import { getGoogle, setAdmin, saveModified, saveRequests, loadAll, resetAdminToGoogleForTenant, reloadAllForTenant } from '@/lib/dataStore';
...
export async function POST() {
  ...
  if (tenantId) {
    resetAdminToGoogleForTenant(tenantId);
